...
import '../features/coupons/domain/use_cases/get_users_coupons_use_case.dart';

Future<void> injectCoupons() async {
  sl.registerLazySingleton(() => GetCouponsUseCase(couponRepository: sl()));
  sl.registerLazySingleton(() => GetUserCouponsUseCase(couponRepository: sl()));
  sl.registerLazySingleton<CouponsUseCases>(
      () => CouponsUseCases(getCouponsUseCase: sl(), getUSerCouponsUseCase: sl()));
