...
DeliveryMethod deliveryMethodFromJson(String str) =>
    DeliveryMethod.fromJson(json.decode(str));
...
class DeliveryMethod {
  ...
  factory DeliveryMethod.fromJson(Map<String, dynamic> json) => DeliveryMethod(
        ...
        data: List<DeliveryMethodData>.from(
            json["data"].map((x) => DeliveryMethodData.fromJson(x))),
      );
