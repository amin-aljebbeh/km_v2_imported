...
class DeliveryMethod {
  DeliveryMethod({this.success, this.data});
...
class DeliveryMethodData {
  DeliveryMethodData({this.id, this.name, this.pivot});
  ...
  factory DeliveryMethodData.fromJson(Map<String, dynamic> json) =>
      DeliveryMethodData(id: json["id"], name: json["name"], pivot: Pivot.fromJson(json["pivot"]));

  Map<String, dynamic> toJson() => {"id": id, "name": name, "pivot": pivot.toJson()};
}

class Pivot {
  Pivot({this.supportedCityId, this.deliveryMethodId, this.price, this.isActive, this.message});
