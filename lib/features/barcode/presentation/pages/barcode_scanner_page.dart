import 'package:kammun_app/features/products_view/pages/barcode_products.dart';
...
class BarcodeScannerPage extends StatefulWidget {
  ...
  const BarcodeScannerPage({Key key, @required this.requestType, this.onIgnore, this.product}) : super(key: key);
