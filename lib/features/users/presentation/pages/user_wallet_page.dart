                    ...
                    Padding(
                      ...
                      child: LabelRow(
                          ...
                          leftSideText: StringUtils()
                                  .oCcy
                                  .format(int.parse(widget.balance.replaceAll('-', 'replace').split('')[0])) +
                              ' ' +
                              LoadingScreenServices.companyInformation.currency,
                          leftSideStyle:
                              widget.balance.contains('-') ? loseStyle : warehouseStyle.copyWith(color: Colors.black)),
                    ),
                    SizedBox(
                      child: Padding(
                        padding: const EdgeInsets.symmetric(vertical: 8),
                      ...
                      if (valueController.text.isEmpty) {
                        ...
                        showMyDialog(
                            ...
                            content: RichText(
                              text: TextSpan(
                                children: <TextSpan>[
                                  TextSpan(text: 'سيتم شحن مبلغ ', style: dialogStyle.copyWith(color: Colors.black)),
                                  TextSpan(
                                  ...
                                  negative
                                      ? TextSpan(
                                          text: 'من ',
                                          style: dialogStyle.copyWith(color: Colors.black, fontWeight: FontWeight.w900))
                                      : TextSpan(
                                          text: 'إلى ',
                                          style:
                                              dialogStyle.copyWith(color: Colors.black, fontWeight: FontWeight.w900)),
