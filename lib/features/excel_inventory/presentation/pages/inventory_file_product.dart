                                    ...
                                    : ListView.builder(
                                        ...
                                        itemBuilder: (BuildContext context, int index) {
                                          ...
                                          return InventoryProductWidget(
                                            ...
                                            onChangePrice: (newValue) => showList[index].price = newValue,
                                            onChangeUnit: (newValue) => showList[index].unit = newValue,
                                            onChangeQuantity: (newValue) => showList[index].quantity = newValue,
                                          );
                                        },
                                      ),
                  ),
