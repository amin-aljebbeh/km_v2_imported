                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Text(
                                '${StringUtils().oCcy.format(state.cartState.cartProducts.fold(0, (sum, order) => sum + (int.parse(order.price.split('.')[0]) * order.productCount)) + StaticVariables.deliveryPrice)} ${StaticVariables.companyInformation.currency}',
                                style: mainStyle.copyWith(
                                    fontWeight: FontWeight.w700,
                                    color: Theme.of(context).primaryColorDark,
                                    fontSize: 19),
                                  ...
                                  children: <Widget>[
                                    ...
                                    KammunButton(
                                      ...
                                      onTap: () {
                                        ...
                                        store.dispatch(NoError());
                                        store.dispatch(
                                            UpdateOrderAction(submitOrderEntity: submitOrderEntity, context: context));
                                      },
                                      height: 50,
                                    ),
                                  ],
