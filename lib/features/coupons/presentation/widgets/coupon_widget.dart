...
class CouponWidget extends StatefulWidget {
  ...
  const CouponWidget({Key key, this.couponEntity, this.ctx}) : super(key: key);
                                ...
                                children: [
                                  RichText(
                                    text: TextSpan(
                                      children: <TextSpan>[
                                        TextSpan(
                                            text: 'سيتم إعطاء الكود ',
                                            style: dialogStyle.copyWith(color: Colors.black)),
                                        TextSpan(
                                            text: widget.couponEntity.code + ' ',
                                            style:
                                                dialogStyle.copyWith(color: Colors.black, fontWeight: FontWeight.bold)),
