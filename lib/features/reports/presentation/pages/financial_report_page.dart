...
class _FinancialReportPageState extends State<FinancialReportPage> {
  ...
  List<Widget> _reportCard() {
    ...
    FinancialReportModel response = StoreProvider.of<AppState>(context).state.reportState.financialReportEntity;
    ...
    totalSubWarehouses.add(Center(
      child: SfCircularChart(
        ...
        series: <PieSeries<FinancialWarehouseEntity, String>>[
          PieSeries<FinancialWarehouseEntity, String>(
              pointColorMapper: (FinancialWarehouseEntity warehouse, _) =>
                  warehousesColors[(warehouse.id - 1) % warehousesColors.length],
              explode: true,
              explodeIndex: 0,
              dataSource: response.data.warehouses,
              xValueMapper: (FinancialWarehouseEntity warehouse, _) =>
                  StringUtils().oCcy.format(warehouse.totalCompanyDues),
              yValueMapper: (FinancialWarehouseEntity warehouse, _) => warehouse.totalCompanyDues,
              dataLabelMapper: (FinancialWarehouseEntity warehouse, _) => warehouse.name,
      ...
      child: SfCircularChart(
        ...
        series: <PieSeries<FinancialWarehouseEntity, String>>[
          PieSeries<FinancialWarehouseEntity, String>(
              ...
              yValueMapper: (FinancialWarehouseEntity warehouse, _) => warehouse.totalProfitsShoppers,
              dataLabelMapper: (FinancialWarehouseEntity warehouse, _) => warehouse.name,
              dataLabelSettings: DataLabelSettings(isVisible: true, textStyle: blackBold)),
        ],
      ),
              ...
              child: ListView(
                ...
                children: [
                  ...
                  state.loadingState.loading.isNotEmpty
                      ? const Loader()
                      : state.reportState.financialReportEntity != null
