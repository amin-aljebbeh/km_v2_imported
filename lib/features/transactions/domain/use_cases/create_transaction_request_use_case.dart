...
class CreateTransactionRequestUseCase {
  ...
  CreateTransactionRequestUseCase({this.transactionsRepository});

  Future<Either<Failure, Unit>> call({TransactionRequestEntity transactionRequestEntity}) async {
    return await transactionsRepository.createTransactionRequest(transactionRequestEntity: transactionRequestEntity);
  }
}
