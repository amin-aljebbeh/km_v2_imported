...
import 'package:kammun_app/features/supplier/domain/entities/account_statement_entity.dart';
...
class SupplierRepositoryImplement implements SupplierRepository {
  ...
  @override
  Future<Either<Failure, List<RemainingStatementEntity>>> remainingMoneyForSupplier({String from, String to}) async {
    try {
      List<RemainingStatementEntity> statment =
          await supplierRemoteDataSource.remainingMoneyForSupplier(from: from, to: to);
      return Right(statment);
    } on CacheException {
      return Left(CacheFailure());
    } on ServerException {
