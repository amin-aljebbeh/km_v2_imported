...
import 'package:kammun_app/features/orders_feature/orders_services.dart';
    ...
    return InkWell(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          if (Services.hasRole(context, operationManagerRole)) OperationButtonsWidget(order: order),
